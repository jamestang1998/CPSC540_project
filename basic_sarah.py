...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 13 01:56:40 2021
...
class SARAH(BaseVROptimizer):

    def __init__(self, params, N, batch_sizes,use_numba=False, lr=1e-2, eps=1e-6):
        self.N = N
    ...
    def _step(self, model_parameters, optimizer_parameters):
        ...
        #print('######## vt-1 ######')
        #print('vt-1',self.prev_full_grad)
        self.passed_samples += 1
        #print('##### gradient of wt #####')
        #print(model_parameters['grads'])
